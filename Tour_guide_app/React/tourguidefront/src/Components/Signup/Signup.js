        ...
        <div class="row">
            <div class="col-3">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <input type="file" class="form-control" id="exampleInputPassword1" placeholder="Image" name='Image' onChange={(e)=>{console.log(e.target.files[0]);setState({...state,'Image':e.target.files[0]});}}></input>
                  </div>
                  <div class="form-group">
